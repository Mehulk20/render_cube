...
const CTASection = () => {
  ...
  return (
    ...
    //                 Start selling your assets in minutes
    //               </p>
    //             </div>
    //             <button
    ...
    //               {['Zero upfront fees', 'Keep up to 80% revenue', 'Reach a global audience'].map(
    //                 (perk) => (
    //                   <div
    //                     key={perk}
    ...
    <section className="relative overflow-hidden bg-background py-24 lg:py-28 transition-surface">
      {/* Background */}

      <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center">
        <div className="h-72 w-72 rounded-full bg-gradient-to-br from-brand-400 to-brand-600 opacity-20 blur-3xl" />
      </div>

      <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center">
        <div className="h-72 w-72 rounded-full bg-gradient-to-br from-fuchsia to-brand-500 opacity-20 blur-3xl" />
      </div>
