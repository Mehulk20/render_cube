...
import { AssetCard, SearchBar } from '../../components/public';
...
const ALL_ASSETS = [
  ...
  },
  {
    ...
    creator: 'Colorist Co.',
    price: '19',
    gradient: 'bg-gradient-to-br from-sky-700 via-blue-600 to-indigo-800',
    badge: null,
    category: 'Video Assets',
    rating: 4.6,
    reviews: 187,
  },
  {
    ...
    price: '15',
    gradient: 'bg-gradient-to-br from-fuchsia-600 via-pink-500 to-violet-700',
    badge: null,
    category: 'Graphics',
    rating: 4.5,
    reviews: 203,
  ...
  },
  {
    ...
    price: '22',
    gradient: 'bg-gradient-to-br from-amber-700 to-red-800',
    badge: null,
    category: 'Fonts',
    rating: 4.7,
    reviews: 134,
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-300 page-transition">
      ...
      <div className="pt-24 pb-8 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
        <div className="max-w-7xl mx-auto">
          <h1
            className="text-3xl font-display font-bold text-gray-900 dark:text-white mb-1"
          ...
          >
            {sorted.map((asset) =>
              viewMode === 'grid' ? (
                ...
                <div
                  key={asset.id}
                  className="flex items-center gap-4 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-4 card-hover cursor-pointer"
                >
