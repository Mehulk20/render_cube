...
import { addItemToCart, selectCartItems } from '../../features/cart';
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-300 page-transition">
      <div className="pt-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <Link
          to="/marketplace"
          className="inline-flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:text-primary transition-colors text-sm mb-8"
        >
        ...
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-3 space-y-4">
            <div
              className={`w-full h-80 rounded-3xl ${asset.gradient} relative overflow-hidden shadow-2xl`}
            >
            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-6 border border-gray-100 dark:border-gray-800">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {asset.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 bg-purple-50 dark:bg-purple-950 text-primary text-xs font-medium rounded-full"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 p-6 shadow-sm sticky top-24">
              ...
              {/* Title */}
              <h1
                className="text-xl font-display font-bold text-gray-900 dark:text-white leading-tight mb-3"
