      ...
      <div className="pt-24 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <Link
              to="/marketplace"
              className="inline-flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:text-primary transition-colors text-sm mb-2"
            >
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div>
            <div className="bg-gray-50 dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 p-6 sticky top-24">
              <h2
                className="text-lg font-display font-bold text-gray-900 dark:text-white mb-5"
                style={{ fontFamily: 'Syne' }}
              >
                Order Summary
              </h2>
