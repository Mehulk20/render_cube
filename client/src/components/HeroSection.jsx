...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen bg-white dark:bg-gray-950 bg-grid overflow-hidden pt-4 transition-colors duration-300">
      {/* Background blobs */}
      <AuroraBackground />
      <div className="absolute top-20 right-0 w-[600px] h-[600px] bg-purple-100 dark:bg-purple-900/20 rounded-full blur-3xl opacity-40 translate-y-1/4 translate-x-1/4 pointer-events-none animate-float" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-pink-100 dark:bg-pink-900/20 rounded-full blur-3xl opacity-30 translate-y-1/4 translate-x-1/4 pointer-events-none animate-float-delayed" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-16 flex items-center min-h-[calc(100vh-64px)]">
        <div className="grid lg:grid-cols-2 gap-10 xl:gap-16 items-center w-full">
          ...
          <div className="relative h-[480px] hidden lg:block">
            ...
            <div
              className="absolute bottom-14 left-14 w-18 h-18 rounded-2xl shadow-lg animate-float-delayed flex items-center justify-center bg-gradient-to-br from-purple-500 to-pink-500"
