      ...
      <div className="mx-auto flex h-16 max-w-360 items-center gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-1 lg:flex">
          <div className="relative">
            ...
            {browseOpen && (
              <div className="absolute left-0 top-full mt-2 w-52 rounded-xl border border-border bg-surface p-2 shadow-2xl">
                {browseLinks.map((l) => (
                  <Link
                    key={l}
                    to="/explore"
        ...
        <div className="ml-auto flex items-center gap-1.5 sm:gap-3">
          ...
          {isAuthed ? (
            <div className="relative">
              ...
              {menuOpen && (
                <div className="absolute right-0 top-full mt-2 w-56 rounded-xl border border-border bg-surface p-1.5 shadow-2xl">
