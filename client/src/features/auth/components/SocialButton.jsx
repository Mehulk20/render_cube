...
const icons = {
  google: (
    <svg viewBox="0 0 24 24" className="h-[18px] w-[18px]">
      ...
      <path
        fill="#34A853"
        d="M12 24c3.24 0 5.95-1.07 7.94-2.9l-3.88-3.01c-1.08.72-2.46 1.15-4.06 1.15-3.12 0-5.77-2.11-6.71-4.94H1.28v3.1A11.998 11.998 0 0 0 12 24z"
      />
      <path
        fill="#FBBC05"
      ...
      <path
        fill="#EA4335"
        d="M12 4.75c1.76 0 3.34.6 4.58 1.79l3.44-3.44C17.94 1.19 15.24 0 12 0 7.31 0 3.26 2.69 1.28 6.6l4.01 3.1C6.23 6.86 8.88 4.75 12 4.75z"
      />
    </svg>
  ),
  github: (
...
export default function SocialButton({ provider, label, onClick }) {
  return (
    <motion.button
      ...
      whileHover={{ y: -1 }}
      className="
        flex w-full items-center justify-center gap-md rounded-sm border border-border bg-surface py-md
