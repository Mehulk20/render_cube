  ...
  return (
    <div className="relative hidden w-full max-w-xl flex-col justify-center overflow-hidden px-6 lg:flex lg:px-14 xl:px-20">
      ...
      <motion.h1
        ...
        className="font-display text-5xl font-extrabold leading-[1.08] tracking-tight text-foreground xl:text-6xl"
      >
        Create.
        <br />
        Share.
      ...
      <motion.p
        ...
        className="mt-5 max-w-md text-[15px] leading-relaxed text-foreground-soft"
      >
