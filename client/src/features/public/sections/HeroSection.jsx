...
export default function HeroSection() {
  return (
    <Section className="relative min-h-screen overflow-hidden bg-background bg-grid py-0">
      <AuroraBackground />
      ...
      <Container className="relative flex min-h-[calc(100vh-64px)] items-center py-6">
        <div className="grid max-w-7xl mx-auto items-center gap-10 lg:grid-cols-2 xl:gap-16">
          <HeroContent />
