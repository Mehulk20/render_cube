    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <Card className="overflow-hidden p-0">
        <div className="relative">
          ...
          <button
            type="button"
            className="absolute right-3 top-3 flex items-center gap-1.5 rounded-lg bg-black/40 px-3 py-1.5 text-xs font-medium text-white backdrop-blur-sm hover:bg-black/60"
          >
        ...
        <div className="flex items-center gap-4 px-5 pb-5 pt-4 sm:px-6">
          <span className="relative -mt-14">
            ...
            <button
              type="button"
              className="absolute bottom-0 right-0 flex h-7 w-7 items-center justify-center rounded-full bg-violet text-white ring-4 ring-surface"
            >
              <Camera size={12} />
            </button>
          </span>
          <p className="text-xs text-ink-faint">JPG, PNG or WEBP. Max size 2MB.</p>
        </div>
      </Card>
      ...
      <Card className="space-y-3 p-5 sm:p-6">
        ...
        {social.map((s, i) => (
          <div key={s.platform} className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-ink-faint hover:bg-surface-raised hover:text-rose"
            >
              <Minus size={15} />
            </button>
          </div>
        ...
        <button
          type="button"
          className="flex items-center gap-1.5 text-sm font-medium text-violet hover:text-fuchsia"
        >
        ...
        <Card className="space-y-4 p-5 sm:p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <label className="block">
              <span className="mb-1.5 block text-sm font-medium text-ink-soft">Store URL</span>
              <div className="flex items-center rounded-xl border border-border bg-surface-raised px-3.5 py-2.5 text-sm">
                <span className="text-ink-faint">motionenvato.com/</span>
                <input
